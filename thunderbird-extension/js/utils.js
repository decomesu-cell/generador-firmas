...
function envolverFirmaConSeparador(htmlFirma) {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;clear:both;margin:0;">
  <tr>
    <td align="left" style="padding:0;text-align:left;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="left" style="border-collapse:collapse;margin:0;">
        <tr><td style="border-top:1px solid #d9d9d9;padding-top:12px;">${htmlFirma}</td></tr>
      </table>
    </td>
  </tr>
</table>`;
