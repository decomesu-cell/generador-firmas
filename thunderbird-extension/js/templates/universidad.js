...
function generarFirmaUniversidadBase(d, colores) {
  ...
  const cabecera = anchoCabeceraEstimado <= 400
    ...
    : `<tr><td align="center" style="padding:0;text-align:center;line-height:22px;"><span style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;font-weight:400;color:${colores.nombre};">${d.nombreCompleto}</span></td></tr><tr><td align="center" style="padding:0 0 8px;text-align:center;line-height:18px;"><span style="color:${colores.separador};">·&nbsp;&nbsp;</span><span style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;color:${colores.puesto};">${d.cargo}</span></td></tr>`;
