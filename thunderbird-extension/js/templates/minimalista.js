...
function generarFirmaMinimalista(d) {
  ...
  const filaUrgenciasReferencia = (!d.oficina.esLineaUrgencias && d.oficina.telefonoUrgenciasReferencia && d.mostrarUrgenciasReferencia !== false)
    ? `<tr><td style="font-size:11.5px; color:#666666; padding-bottom:4px;">Emergencias ${enlaceTelefono(d.oficina.telefonoUrgenciasReferencia)}&nbsp;<sup style="font-size:7px;font-weight:700;color:${e.colorAcento};vertical-align:super;line-height:0;">24H</sup></td></tr>`
    : '';
